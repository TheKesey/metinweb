// Mock data — original content for "Kesey" fan-server prototype.
// Names, items, lore are original, not pulled from the actual game.
...
window.MOCK = (() => {
  const news = [
    ...
    },
    {
      ...
      read_min: 7,
      body_hu: [
        "A pénzügyi rendszer komplex egyensúly. Túl sok yang és inflációt kapsz, túl kevés és a piac megáll. Ezt a blog-cikket arról írtuk, hogyan vágunk át rajta.",
        "A legfontosabb mechanika a heti adó: minden tranzakcióból 2% eltűnik a rendszerből. Ez tartja stabilan a kínálatot.",
      ...
      body_en: [
        "Currency systems are a delicate balance. Too much yang and you get inflation, too little and the market stalls. Here's how we thread the needle.",
        "The key mechanic is a weekly tax: 2% of every transaction is sunk. This keeps supply in check.",
  ...
  const items = [
    ...
    { id: "i4", name_hu: "Tartalék mána főzet (×100)", name_en: "Mana Tonic ×100", cat: "consumable", rarity: "common", price: 120, oldPrice: null, popular: 70, new: false, desc_hu: "Tömeges csomag, használat utáni 5 mp cooldown.", desc_en: "Bulk pack, 5s cooldown after use." },
    ...
    { id: "i12", name_hu: "EXP főzet ×50", name_en: "EXP Tonic ×50", cat: "consumable", rarity: "common", price: 180, oldPrice: null, popular: 90, new: false, desc_hu: "1 óra +20% EXP, használat utáni cooldown.", desc_en: "1 hour +20% EXP, has cooldown." },
  ];
  ...
  // Online players (subset has location)
  const locations = [
  ...
  return { news, items, players, online, guilds, locations, liveFeed, characters, orders, transactions, topupTiers };
})();
